...
config = Config('/apollo/data/autotest/apotest/Locate/detect_localization.config')
...
class Test(unittest.TestCase):
    ...
    def test_cpu(self):
        assert 1 == 2 - 1
    def test_case(self):
        Locate_info = reaily.TopicInfo(config.AllTopics())['/apollo/localization/pose']
        Exp_Locate_info = output['/apollo/localization/pose']
        assert Locate_info == Exp_Locate_info
