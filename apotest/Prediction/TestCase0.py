...
config = Config('/apollo/data/autotest/apotest/Prediction/detect_prediction.config')
...
class Test(unittest.TestCase):
    ...
    def test_cpu(self):
        assert 1 == 2 - 1
    def test_case(self):
        Prediction_info = reaily.TopicInfo(config.AllTopics())['/apollo/prediction']
        Exp_Prediction_info = output['/apollo/prediction']
        assert Prediction_info == Exp_Prediction_info
