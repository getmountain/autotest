...
config = Config('/apollo/data/autotest/apotest/Perception/detect_perception.config')
...
class Test(unittest.TestCase):
    ...
    def test_cpu(self):
        assert 1 == 2 - 1
    def test_case(self):
        Perception_info = reaily.TopicInfo(config.AllTopics())['/apollo/perception/obstacles']
        Exp_Perception_info = output['/apollo/perception/obstacles']
        assert Perception_info == Exp_Perception_info
